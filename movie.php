...
if (!empty($movieid)) {
$str = file_get_contents('https://api.themoviedb.org/3/movie/'.$movieid.'?api_key='.$ImdbApi);
...
<div class="container">
    ...
    <div class="row">
      ...
      <div class="col-md-6">
          ...
          <div class="tmdbdescript">
            ...
            <?php
              $desc = file_get_contents('https://api.themoviedb.org/3/movie/'.$movieid.'/translations?api_key='.$ImdbApi);
  ...
  <?php  if($related == 1 ){ ?>
    <div class="breakspace"></div>
      <?php 
          $str = file_get_contents('https://api.themoviedb.org/3/movie/'.$movieid.'/similar?api_key='.$ImdbApi);
          $json = json_decode($str, true);
  ...
  <div class="spaces" ></div>
  <?php
    $str = file_get_contents('https://api.themoviedb.org/3/movie/'.$movieid.'/videos?api_key='.$ImdbApi);
    $json = json_decode($str, true);
  ?>
